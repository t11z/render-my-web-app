...
export const privacy: Record<Locale, LegalDoc> = {
  en: {
    ...
    html: `
      ...
      <h2>1. Controller</h2>
      <p>, , , Germany. Contact: see <a href="/impressum.html">Imprint</a>.</p>
  ...
  de: {
    ...
    html: `
      ...
      <p>, , , Deutschland. Kontakt siehe <a href="/impressum.html">Impressum</a>.</p>
  ...
  es: {
    ...
    html: `
      ...
      <h2>1. Responsable</h2>
      <p>, , , Alemania. Contacto: véase el <a href="/impressum.html">Aviso legal</a>.</p>
  ...
  fr: {
    ...
    html: `
      ...
      <h2>1. Responsable</h2>
      <p>, , , Allemagne. Contact : voir les <a href="/impressum.html">mentions légales</a>.</p>
  ...
  pt: {
    ...
    html: `
      ...
      <h2>1. Responsável</h2>
      <p>, , , Alemanha. Contato: ver o <a href="/impressum.html">aviso legal</a>.</p>
  ...
  'zh-Hans': {
    ...
    html: `
      <h1>隐私政策</h1>
      <h2>1. 责任方</h2>
      <p>，，，德国。联系方式：参见<a href="/impressum.html">法律声明</a>。</p>
      <h2>2. 原则：零知识</h2>
