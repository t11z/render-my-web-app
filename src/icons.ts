// Heroicons (https://heroicons.com) — MIT licensed, by Tailwind Labs.
// Outline (24×24) path data inlined so no runtime dependency ships.

const svg = (d: string): string =>
  `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="${d}" /></svg>`
...
export function setIcon(el: Element, name: string): void {
